...
tf.app.flags.DEFINE_integer("ps_hosts", 0, "Parameter server hosts")
tf.app.flags.DEFINE_integer("worker_hosts", 0, "Worker hosts")
tf.app.flags.DEFINE_integer("server_protocol", 0, "Server protocol")
